        ...
        <div className={styles.actions}>
          ...
          <button className={styles.closeButton} onClick={onClose}>
            <svg
              ...
              xmlns="http://www.w3.org/2000/svg"
            >
              <path d="M10.7442 2.28919L2.25896 10.7745C1.96905 11.0644 1.48821 11.0644 1.1983 10.7745C0.908385 10.4846 0.908385 10.0037 1.1983 9.71381L9.68358 1.22853C9.9735 0.938614 10.4543 0.938614 10.7442 1.22853C11.0342 1.51844 11.0342 1.99927 10.7442 2.28919Z" fill="#253017"/>
              <path d="M10.7442 10.7734C10.4543 11.0633 9.9735 11.0633 9.68358 10.7734L1.1983 2.28814C0.908385 1.99823 0.908385 1.5174 1.1983 1.22748C1.48821 0.937569 1.96905 0.937569 2.25896 1.22748L10.7442 9.71277C11.0342 10.0027 11.0342 10.4835 10.7442 10.7734Z" fill="#253017"/>
            </svg>
          </button>
        </div>
      </div>
